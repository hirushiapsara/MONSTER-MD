...
try {
    ...
    console.log("🌍 Connected to the SHAMIKA  DB")
} catch {
...
let cc = Config.sessionName.replace(/SHAMIKA;;;/g, "").replace(/SHAMIKA;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
